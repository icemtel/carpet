...
\newcommand{\si}[2]{\sin  \fr{#1}{#2} } %shortcut for sin, cos, exp
...
%  \centering
% \includegraphics[width=.9\textwidth]{assets/theory-2019-08-26-160946838-d74.png}
%  \caption{A}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=.95\textwidth]{assets/theory-2019-08-27-181715342-e4b.png}
    % \caption{}
    %\label{fig:crack}
\end{figure}

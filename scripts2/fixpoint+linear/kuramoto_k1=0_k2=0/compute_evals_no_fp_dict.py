...
2020-07-02: save as .npy

2020-08-18: don't use fixpoint dict: load 0-twist or raise an error

IMPORTANT:
- check fixpoint_dict.pkl location
...
import carpet
from sim_setup import solve_cycle, nx, ny, N, get_mtwist

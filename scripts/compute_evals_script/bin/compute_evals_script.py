...
# 2019-07-31 Choose any perturbation basis of N-1 vectors, with zero mean phase
...
def get_mtwist_trig_basis(delta0=1):
    '''
    ...
    for k1 in range(nx):
        for k2 in range(ny):
            ...
            cos_mtwist = sp.cos(get_mtwist(k1, k2))
            sin_mtwist = sp.sin(get_mtwist(k1, k2))

...
right_side_of_ODE = physics.define_right_side_of_ODE_kuramoto(NN, freq_vec, sin_str, use_numba=True)
...
def define_solve_cycle_class(NN_class, TT_class):
    physics.define_right_side_of_ODE_kuramoto(NN_class, freq_vec, sin_str, use_numba=True)
